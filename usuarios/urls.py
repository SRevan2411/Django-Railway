...
from .views import RegisterView,LoginView,GetUserProfileView,CourseCreateView,CourseAllListView,CourseListView, ResourceCreateView, VideoListView, ResourceUpdateView, ResourceDeleteView, UserProfileDetailView
